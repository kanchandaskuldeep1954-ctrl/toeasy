...
const Sidebar: React.FC<SidebarProps> = ({ mobileOpen = false, onClose }) => {
    ...
    const navItems = [
        ...
        { name: 'Chat', path: buildChatPath(), icon: 'M8 10h8M8 14h5m6 7l-4-4H6a2 2 0 01-2-2V7a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z' },
