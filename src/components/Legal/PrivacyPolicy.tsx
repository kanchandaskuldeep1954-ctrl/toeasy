        ...
        <div className="py-20 px-4 max-w-4xl mx-auto space-y-12">
            ...
            <div className="space-y-10 text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                <div className="pt-12 border-t border-slate-200 dark:border-slate-800 text-center">
                    <p className="text-sm text-slate-500">For any privacy-related concerns, please contact our Data Protection Officer at <a href="mailto:privacy@toeasy.online" className="text-indigo-600 font-bold hover:underline">privacy@toeasy.online</a>.</p>
                </div>
            </div>
        </div>
    );
