      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <button
              ...
              className="text-indigo-400 hover:text-indigo-300 text-sm mb-2 flex items-center gap-1"
            >
              ← Back to Workspaces
            </button>
            <h1 className="text-3xl font-bold text-white mb-2">Datasets</h1>
            <p className="text-slate-400">Manage your datasets in this workspace</p>
          </div>
          <button
        ...
        {datasets.length === 0 ? (
          <div className="text-center py-12 bg-slate-900 border border-slate-800 rounded-xl">
            ...
            <p className="text-slate-400 mb-4">No datasets uploaded yet in this workspace</p>
          ...
          <>
            {/* Pagination Controls */}
            <div className="flex items-center justify-between mb-4 bg-slate-900 border border-slate-800 rounded-lg p-4">
              <div className="flex items-center gap-4">
                <label className="text-sm text-slate-300 flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-3 py-1 bg-slate-800 border border-slate-700 rounded text-white text-sm font-medium"
                  >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-medium rounded disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  ← Previous
                </button>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-800">
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold text-slate-300">Rows</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-slate-300">Columns</th>
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-indigo-600/20 rounded flex items-center justify-center border border-indigo-500/50">
                            <svg
                      ...
                      <td className="px-6 py-4 text-white">{dataset.row_count.toLocaleString()}</td>
                      <td className="px-6 py-4 text-white">{dataset.column_count}</td>
                      <td className="px-6 py-4 text-slate-400">{formatBytes(dataset.file_size)}</td>
